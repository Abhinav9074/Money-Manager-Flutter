...
class EditTransactionsSample extends StatefulWidget {
  ...
  EditTransactionsSample(
      ...
      required this.dateSum,
      this.image = ''});

  @override
  State<EditTransactionsSample> createState() => _EditTransactionsSampleState();
}

class _EditTransactionsSampleState extends State<EditTransactionsSample> {
