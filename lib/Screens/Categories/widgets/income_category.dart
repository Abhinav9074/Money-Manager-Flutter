                                                                    ...
                                                                    return SimpleDialog(
                                                                      title:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              '$randomNumber',
                                                                              style: const TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'texgyreadventor-regular', fontSize: 25, fontWeight: FontWeight.w700, letterSpacing: 5)),
                                                                        ],
                                                                      ),
                                                                      children: [
                                                                        Form(
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: TextFormField(
                                                                                  ...
                                                                                  obscureText: true,
                                                                                  decoration: const InputDecoration(labelText: 'Enter The Number', labelStyle: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'texgyreadventor-regular', fontSize: 20)),
                                                                                ),
                                                                              ),
                                                                              Row(
